...
export function Google(props: ComponentPropsWithRef<'svg'>) {
  return (
    <svg
      ...
      role='img'
      aria-describedby='google-svg-title'
      viewBox='0 0 92 30'
      {...props}
    >
      <title id='google-svg-title'>Google</title>
      <path
      ...
      <path
        ...
        className='fill-cpt-blue'
      />
      <path d='M75 1.17V22.9h-3V1.17h3z' className='fill-cpt-green' />
      <path
